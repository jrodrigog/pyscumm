...
class Image( Object ):
    ...
    def __init__( self, texture = None ):
        ...
        self._size    = pyscumm.vector.Vector2D()
        if texture:
    ...
    def draw( self ):
        ...
        OpenGL.GL.glTexCoord2f( *self._tc[1] ); OpenGL.GL.glVertex2f( self._size[0], 0             )
        OpenGL.GL.glTexCoord2f( *self._tc[2] ); OpenGL.GL.glVertex2f( self._size[0], self._size[1] )
        OpenGL.GL.glTexCoord2f( *self._tc[3] ); OpenGL.GL.glVertex2f( 0            , self._size[1] )
        OpenGL.GL.glEnd()
