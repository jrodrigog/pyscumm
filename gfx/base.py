...
class Drawable( object ):
	...
	def __init__( self ):
		self._location  = Vector3D( [0.,0.,0.] )
		self._insertion = Vector3D( [0.,0.,0.] )
		self._rotation  = Vector4D( [0.,0.,0.,1.] )
		self._color     = Vector4D( [1.,1.,1.,1.] )
		self._scale     = Vector3D( [1.,1.,1.] )
		self._speed     = Vector3D( [0.,0.,0.] )
		self._copy      = self
		self._name      = None
		self._visible   = True
		self._solver    = SpeedSolver.instance()
		self._child     = []
